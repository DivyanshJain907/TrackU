...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 bg-slate-900/50 backdrop-blur border-b border-purple-500/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <Link
                  href="/about"
                  className="border-2 border-purple-500 text-purple-400 hover:bg-purple-500/10 px-8 py-4 rounded-lg font-semibold transition text-center"
                >
                  Learn More
                </Link>
              </div>
      ...
      <footer className="border-t border-purple-500/20 py-8 px-4 bg-slate-900/50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-purple-500/20 pt-8 text-center text-gray-400 text-sm">
            ...
            <p className="mt-2">Developed by <Link href="https://www.thejainagency.shop/" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300 transition">Jain Agency</Link></p>
          </div>
        </div>
      </footer>
      </div>
